<?php
/**
 * API Handler: Accept Mentee Request
 * POST /api/accept_request.php
 * 
 * Parameters:
 *   - request_id (int): ID of request to accept
 */
...
if ($user_role !== 'mentor') {
    ...
    $response['message'] = 'Only mentors can accept requests';
    echo json_encode($response);
    exit;
}

// Accept the request
$result = accept_mentee_request($pdo, $request_id, $user_id);
