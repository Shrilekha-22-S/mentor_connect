...
<head>
    ...
    <title>Mentor Dashboard - Mentor Connect</title>
    ...
    <div class="d-flex">
        ...
        <div class="sidebar col-md-3 col-lg-2">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="calendar.php"><i class="bi bi-calendar-event"></i> Calendar</a></li>
        ...
        <div class="col-md-9 col-lg-10">
            <!-- Topbar -->
            <div class="topbar">
                <h2><i class="bi bi-speedometer2"></i> Mentor Dashboard</h2>
                <div class="user-menu">
                    <div class="user-info">
                        <p>Welcome back!</p>
            ...
            <div class="main-content">
                ...
                <div class="welcome-section">
                    ...
                    <p>Manage your mentees and track your mentoring progress from this dashboard.</p>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="dashboard-card">
                            <h3><i class="bi bi-person-hearts"></i> My Mentees</h3>
                            <p>View and manage all your mentees, track their progress, and provide guidance.</p>
                    ...
                    <div class="col-md-6">
                        <div class="dashboard-card">
                            ...
                            <p>Communicate with your mentees through messages and share resources.</p>
                            <button class="btn btn-primary mt-3" disabled>Coming Soon</button>
                        </div>
                    </div>
                </div>
